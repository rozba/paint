...
def draw_tools(active_color,active_size):
    ...
    white = pygame.draw.rect(screen,(0,0,0),[WIDTH-85, 35,25,25])
    black = pygame.draw.rect(screen,(255,255,255),[WIDTH-110,10,25,25])
    purple = pygame.draw.rect(screen,(255,0,255),[WIDTH-110, 35,25,25])

    pygame.draw.circle(screen,active_color,(400,35),30)
    pygame.draw.circle(screen,'dark gray', (400,35),3)

    color_rect = [blue,red,green,yellow,teal,black,purple,white]
    rgb_list = [(0,0,255),(255,0,0),(0,255,0),(255,255,0),(0,255,255),(255,255,255),(255,0,255),(0,0,0)]
...
while(run):
    ...
    brushes, colors, rgbs = draw_tools(active_color,active_size)
